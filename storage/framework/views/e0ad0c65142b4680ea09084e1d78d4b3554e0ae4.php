                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e($notice->notice_type); ?></td>
                                                <td><?php echo e($notice->notice_description); ?></td>
                                                <td><?php echo e($notice->notice_date); ?></td>
                                                <td><?php echo e($notice->notice_by); ?></td>
                                                <td>
                                                    <!-- <a href='<?php echo e(url("/notices/{$notice->id}")); ?>'>
                                                        <button type="button" class="btn btn-primary btn-xs"><i class="fa fa-user"></i> Profile</button>
                                                    </a> -->

                                                    <a href='<?php echo e(url("/notices/{$notice->id}/edit")); ?>'>
                                                        <button type="button" class="btn btn-success btn-xs"><i class="fa fa-pencil-square-o"></i> Edit</button>
                                                    </a>

                                                    <form method="POST" action='<?php echo e(url("/notices/{$notice->id}")); ?>'>
