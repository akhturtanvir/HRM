                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?php echo e($award->id); ?></td>
                                                <td><?php echo e($award->award_name); ?></td>
                                                <td><?php echo e($award->award_description); ?></td>
                                                <td><?php echo e($award->gift_item); ?></td>
                                                <td><?php echo e($award->date); ?></td>
                                                <td><?php echo e($award->employee_id); ?></td>
                                                <td><?php echo e($award->awarded_by); ?></td>
                                                <td>
                                                    <!-- <a href='<?php echo e(url("/awards/{$award->id}")); ?>'>
                                                        <button type="button" class="btn btn-primary btn-xs"><i class="fa fa-user"></i> Profile</button>
                                                    </a> -->

                                                    <a href='<?php echo e(url("/awards/{$award->id}/edit")); ?>'>
                                                        <button type="button" class="btn btn-success btn-xs"><i class="fa fa-pencil-square-o"></i> Edit</button>
                                                    </a>

                                                    <form method="POST" action='<?php echo e(url("/awards/{$award->id}")); ?>'>
