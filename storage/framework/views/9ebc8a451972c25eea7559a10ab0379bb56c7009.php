                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e($department->department_address); ?></td>
                                                <td><?php echo e($department->department_details); ?></td>
                                                <td>
                                                    <!-- <a href='<?php echo e(url("/departments/{$department->id}")); ?>'>
                                                        <button type="button" class="btn btn-primary btn-xs"><i class="fa fa-user"></i> Profile</button>
                                                    </a> -->

                                                    <a href='<?php echo e(url("/departments/{$department->id}/edit")); ?>'>
                                                        <button type="button" class="btn btn-success btn-xs"><i class="fa fa-pencil-square-o"></i> Edit</button>
                                                    </a>

                                                    <form method="POST" action='<?php echo e(url("/departments/{$department->id}")); ?>'>
