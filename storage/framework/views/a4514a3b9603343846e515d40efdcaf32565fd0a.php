                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            ...
                            <div class="card-block">
                                <form  method="POST" action='<?php echo e(url("/awards/{$awards->id}")); ?>'>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="award_name" value="<?php echo e($awards->award_name); ?>" name="award_name" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="award_description" value="<?php echo e($awards->award_description); ?>" name="award_description" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="gift_item" value="<?php echo e($awards->gift_item); ?>" name="gift_item" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                <div class="form-group">
                                                    <label>Date</label>
                                                    <!-- <textarea type="text" id="department_details" name="department_details" class="form-control" required></textarea> -->
                                                    <input type="date" id="date" value="<?php echo e($awards->date); ?>" name="date" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
