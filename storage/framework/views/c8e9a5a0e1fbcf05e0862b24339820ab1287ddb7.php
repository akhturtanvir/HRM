                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Create Notice</h4>
                            </div>
                            <div class="card-block">
                                <form  method="POST" action="<?php echo e(route('notices.store')); ?>">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="notice_type" name="notice_type" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="notice_description" name="notice_description" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
