                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?php echo e($leaveapplication->id); ?></td>
                                                <td><?php echo e($leaveapplication->employee_name); ?></td>
                                                <td><?php echo e($leaveapplication->application_start_date); ?></td>
                                                <td><?php echo e($leaveapplication->application_end_date); ?></td>
                                                <td><?php echo e($leaveapplication->approve_start_date); ?></td>
                                                <td><?php echo e($leaveapplication->approve_end_date); ?></td>
                                                <td><?php echo e($leaveapplication->approve_by); ?></td>
                                                <td>

                                                    <a href='<?php echo e(url("/leaveapplications/{$leaveapplication->id}/edit")); ?>'>
                                                        <button type="button" class="btn btn-success btn-xs"><i class="fa fa-pencil-square-o"></i> Edit</button>
                                                    </a>

                                                    <form method="POST" action='<?php echo e(url("/leaveapplications/{$leaveapplication->id}")); ?>'>
