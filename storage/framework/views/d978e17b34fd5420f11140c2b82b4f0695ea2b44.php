                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            ...
                            <div class="card-block">
                                <form  method="POST" action='<?php echo e(url("/holidays/{$holidays->id}")); ?>'>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="holiday_name" value="<?php echo e($holidays->holiday_name); ?>" name="holiday_name" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" id="holiday_start_from" value="<?php echo e($holidays->holiday_start_from); ?>" name="holiday_start_from" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                <div class="form-group">
                                                    <label>To</label>
                                                    <!-- <textarea type="text" id="department_details" name="department_details" class="form-control" required></textarea> -->
                                                    <input type="date" id="holiday_end_to" value="<?php echo e($holidays->holiday_end_to); ?>" name="holiday_end_to" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="number_of_days" value="<?php echo e($holidays->number_of_days); ?>" name="number_of_days" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
