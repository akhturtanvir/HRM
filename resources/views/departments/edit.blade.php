                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            ...
                            <div class="card-block">
                                <form  method="POST" action='{{ url("/departments/{$departments->id}") }}'>
                                    {{ method_field('PUT') }}
                                    {{ csrf_field() }}
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="department_name" value="{{ $departments->department_name}}" name="department_name" class="form-control" placeholder="Human resource management ..." required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="department_address" value="{{ $departments->department_address}}" name="department_address" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="department_details" name="department_details" value="{{ $departments->department_details}}" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
