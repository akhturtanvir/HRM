                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$holiday->holiday_start_from}}</td>
                                                <td>{{$holiday->holiday_end_to}}</td>
                                                <td>{{$holiday->number_of_days}}</td>
                                                <td>{{$holiday->announced_by}}</td>
                                                <td>

                                                    <a href='{{url("/holidays/{$holiday->id}/edit")}}'>
                                                        <button type="button" class="btn btn-success btn-xs"><i class="fa fa-pencil-square-o"></i> Edit</button>
                                                    </a>

                                                    <form method="POST" action='{{url("/holidays/{$holiday->id}")}}'>
                                                        {{ csrf_field() }}
                                                        {{ method_field('DELETE')}}
