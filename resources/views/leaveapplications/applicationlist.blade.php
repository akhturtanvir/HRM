                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$leaveapplication->application_start_date}}</td>
                                                <td>{{$leaveapplication->application_end_date}}</td>
                                                <td>{{$leaveapplication->approve_start_date}}</td>
                                                <td>{{$leaveapplication->approve_end_date}}</td>
                                                <td>{{$leaveapplication->approve_by}}</td>
                                                <td>

                                                    <a href='{{url("/leaveapplications/{$leaveapplication->id}/edit")}}'>
                                                        <button type="button" class="btn btn-success btn-xs"><i class="fa fa-pencil-square-o"></i> Edit</button>
                                                    </a>

                                                    <form method="POST" action='{{url("/leaveapplications/{$leaveapplication->id}")}}'>
                                                        {{ csrf_field() }}
                                                        {{ method_field('DELETE')}}
