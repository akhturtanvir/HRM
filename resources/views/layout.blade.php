...
<head>
    ...
    <link href="{{asset('public/assets/plugins/css-chart/css-chart.css')}}" rel="stylesheet">
    <!-- Custom CSS -->
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li>
                            <a class="has-arrow" href="{{url('/home')}}" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Dashboard <span class="label label-rounded label-success">5</span></span></a>
                        ...
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{url('awards/create')}}">Create Award</a></li>
                                <li><a href="{{url('awards')}}">Awards List</a></li>
                            </ul>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{'holidays/create'}}"> Create Holiday</a></li>
                                <li><a href="{{url('holidays')}}">Holiday List</a></li>
                            </ul>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{url('leaveapplications/create')}}">Create Application</a></li>
                                <li><a href="{{url('leaveapplications')}}">Application List</a></li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="{{url('notices')}}">Notice Board</a></li>
                            </ul>
                        </li>
                        <li>
                            <a class="has-arrow " href="#" aria-expanded="false"><i class="mdi mdi-file-chart"></i><span class="hide-menu">Settings</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{url('generalSetting')}}">General Setting</a></li>
                                <li><a href="{{url('profileSetting')}}">Profile Setting</a></li>
                                <li><a href="{{url('notificationSetting')}}">Notifications Setting</a></li>
                            </ul>
                            </ul>
                        </li>
                    </ul>
...
<!-- Right sidebar -->
                    ...
                    <div class="slimscrollright">
                        ...
                        <div class="r-panel-body">
                            ...
                            <ul class="m-t-20 chatonline">
                                ...
                                <li>
                                    <a href="javascript:void(0)"><img src="{{asset('public/assets/images/users/5.jpg')}}" alt="user-img" class="img-circle"> <span>John Abraham<small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="{{asset('public/assets/images/users/6.jpg')}}" alt="user-img" class="img-circle"> <span>Hritik Roshan<small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="{{asset('public/assets/images/users/7.jpg')}}" alt="user-img" class="img-circle"> <span>Pwandeep rajan <small class="text-success">online</small></span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <!-- Chart JS -->
    <script src="{{asset('public/assets/plugins/echarts/echarts-all.js')}}"></script>
    <!-- Chart JS -->
